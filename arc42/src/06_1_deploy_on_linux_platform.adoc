...
| | | BANK_PROFILE_PATH |
|xs2a-consent-management |Java 8 | ASPSP-PROFILE_BASEURL_INT | 38080
...
| | | LEDGERS_URL_INT  |
| | | CMS_URL_INT  |
| | | ONLINE_BANKING_SCA_LOGINPAGE_INT  |
...
| | | DEV_PORTAL_URL_EXT |
|xs2a-tpp-ui | NGINX 1.15.5 | LEDGERS_URL_INT | 4205
| | |TPP_REST_SERVER_URL_INT |
| | | CERT_GEN_URL_INT |
| xs2a-tpp-rest-server | Java 8 | LEDGERS_URL_INT | 8093
| | | SPRING_DATASOURCE_URL  |
| | | SPRING_DATASOURCE_USERNAME  |
| | | SPRING_DATASOURCE_PASSWORD  |
| | | SERVER_KEY  |
...
| | | CMS_URL_INT | http://localhost:8080 (example) | Mandatory consent-management-system URL
| | | LEDGERS_URL_INT | http://localhost:8088 (example)| Mandatory Ledgers URL
| | | CONSENT_SERVICE_BASEURL | http://localhost:8080/api/v1 (example) | Base consent-management URL for calls to endpoints (CMS_URL_INT + "api/v1")
...
| | | LEDGERS_URL_INT | http://localhost:8088 |
| | | CMS_URL_INT | http://localhost:8080 |
| | | ONLINE_BANKING_SCA_LOGINPAGE_INT | https://demo-dynamicsandbox-onlinebankingui-cloud-adorsys.de/ (example) | Online-banking page, to which user would be redirected in Redirect approach
...
| $JAVA_OPTS_TPP | TPP REST server | LEDGERS_URL_INT | http://localhost:8088 |
