...
public class ParseServiceTest {
    ...
    public void convertMultiPartToFile() throws IOException {
        MultipartFile multipartFile = resolveMultipartFile("team_bank_transaction.csv");
        File file = parseService.convertMultiPartToFile(multipartFile);

        assertThat(file).isNotNull();
        List<UserTransaction> transactions = parseService.convertFileToTargetObject(file, UserTransaction.class);
