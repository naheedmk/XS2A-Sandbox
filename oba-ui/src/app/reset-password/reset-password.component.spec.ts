...
describe('ResetPasswordComponent', () => {
  ...
  let authService: OnlineBankingAuthorizationService;
  let authServiceSpy;
  let de: DebugElement;
  let el: HTMLElement;
  ...
  beforeEach(() => {
    ...
    authService = fixture.debugElement.injector.get(OnlineBankingAuthorizationService);
  ...
  it('should call login on the service', () => {
    authServiceSpy = spyOn(authService, 'sendCodeUsingPOST').and.callThrough();
