...
@FeignClient(value = "cmsPsuAis", url = "${cms.url.int}", path = "/psu-api/v1/ais/consent", primary = false, configuration = FeignConfig.class)
...
public interface CmsPsuAisClient {
    ...
    ResponseEntity updatePsuDataInConsent(
