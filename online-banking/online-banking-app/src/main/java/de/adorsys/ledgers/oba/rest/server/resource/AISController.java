...
public class AISController extends AbstractXISController implements AISApi {
    ...
    public ResponseEntity<AuthorizeResponse> aisAuth(String redirectId, String encryptedConsentId) {
        return auth(redirectId, ConsentType.AIS, encryptedConsentId);
    }
        ...
        if (success) {
            ...
            switch (workflow.scaStatus()) {
                ...
                case SCAMETHODSELECTED:
                    cookieService.setCookies(response, workflow.getConsentReference(),
    ...
    public ResponseEntity<ConsentAuthorizeResponse> selectMethod(
        ...
        try {
            ...
            cookieService.setCookies(response, workflow.getConsentReference(), workflow.bearerToken().getAccess_token(),
    ...
    public ResponseEntity<PIISConsentCreateResponse> grantPiisConsent(String consentAndaccessTokenCookieString, CreatePiisConsentRequestTO piisConsentRequestTO) {
        ...
        try {
            ...
            cookieService.setCookies(response, null, auth.getBearerToken().getAccess_token(), auth.getBearerToken().getAccessTokenObject());
