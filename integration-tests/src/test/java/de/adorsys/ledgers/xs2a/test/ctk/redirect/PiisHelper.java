...
public class PiisHelper {
    ...
    public ResponseEntity<PIISConsentCreateResponse> createPiisConsent(ResponseEntity<AuthorisationResponse> authResponse) {
    ...
    public ResponseEntity<AuthorisationResponse> authCode(ResponseEntity<AuthorisationResponse> authResponseWrapper) {
        ...
        AuthorisationResponse authResponse = authResponseWrapper.getBody();


        ResponseEntity<AuthorisationResponse> authCoderesponseWrapper = obaScaApiClient.validateAuthCode(
    ...
    public ResponseEntity<AuthorisationResponse> choseScaMethod(
        ResponseEntity<AuthorisationResponse> authResponseWrapper) {
        Assert.assertNotNull(authResponseWrapper);
        Assert.assertTrue(authResponseWrapper.getStatusCode().is2xxSuccessful());
        List<String> cookieStrings = authResponseWrapper.getHeaders().get("Set-Cookie");
        ...
        AuthorisationResponse consentAuthorisationResponse = authResponseWrapper.getBody();
        ScaUserDataTO scaUserDataTO = consentAuthorisationResponse.getScaMethods().iterator().next();
        ResponseEntity<AuthorisationResponse> selectMethodResponseWrapper = obaScaApiClient.selectMethod(consentAuthorisationResponse.getEncryptedConsentId(),
    ...
    public ResponseEntity<FundsConfirmationResponse> confOfFund(ResponseEntity<AuthorisationResponse> authResponseWrapper) {
