...
public class ConsentRedirectManyScaIT extends AbstractConsentRedirect {
	...
	public void test_initiate_consent() {
		...
		// ============= SELECT SCA =======================//
		ResponseEntity<ConsentAuthorisationResponse> choseScaMethodResponseWrapper = consentHelper.choseScaMethod(loginResponseWrapper);
		...
		// ============= AUTHORIZE CONSENT =======================//
		ResponseEntity<ConsentAuthorisationResponse> authCodeResponseWrapper = consentHelper.authCode(choseScaMethodResponseWrapper);
